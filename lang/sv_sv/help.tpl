...
<p>
	Registrering krävs för att använda Bokning om du som administratör har aktiverat detta. Efter att ert konto
har registrerats
kommer du att kunna logga in och komma åt alla resurser som du har behörighet till.
</p>

<h2>Bokning</h2>

<p>
	Under menyn Kalender hittar du bokningsbara objektet. Här visas de tillgängliga, de reserverade samt
 blockerade tiderna i kalendern så att du kan boka
 det som passar er .
</p>
...
<p>
	På Bokningssidan Finner du de rum samt datum och tid du vill boka. Att klicka på tidsperioden gör det möjligt för er att
att ändra information om bokningen. Genom att klicka på
 Skapa knappen Kontrolleras tillgången samt att bokning utförs samtidigt skickas ett e-postmeddelande ut. Du kommer att få ett referensnummer som kan användas för bokningsuppföljning.
</p>

<p>Inga ändringar träder ikraft förrän du har sparat din bokningen.</p>

<p>Endast administratörer kan skapa bokning i efterhand.</p>

<h3>Flera bokningar</h3>

<p>Du kan boka alla resurser som du har behörighet som en del av en enda bokning. Om du vill lägga till resurser för
 din bokning, klickar du på Fler resurser bredvid namnet på den primära resurs som du har
 reserverat. Du kommer sedan kunna lägga till fler resurser genom att markera dem och klicka på knappen Klar.</p>

<p>För att ta bort ytterligare resurser från din bokning, klickar du på länken Fler resurser avmarkera de resurser du
 vill ta bort och klickar på knappen Klar.</p>
