 ...
 */
 ...
 $conf['settings']['default.timezone'] = 'Europe/Stockholm';      // look up here http://php.net/manual/en/timezones.php
 $conf['settings']['allow.self.registration'] = 'true';         	// if users can register themselves
 $conf['settings']['admin.email'] = 'marc.peace@symbio.com';         // email address of admin user
 ...
 $conf['settings']['script.url'] = 'http://slowbro.azurewebsites.net/Web';   	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
  ...
  */
 $conf['settings']['install.password'] = '5901ae8fdbf3a';
 /**
  * Pages
  */
