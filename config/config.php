...
$conf['settings']['app.title'] = 'AMF Booking';
$conf['settings']['default.timezone'] = 'Europe/Stockholm';
$conf['settings']['allow.self.registration'] = 'true';
$conf['settings']['admin.email'] = 'admin@amfbooking.se';
$conf['settings']['admin.email.name'] = 'Booking Administrator';
$conf['settings']['default.page.size'] = '50';
$conf['settings']['enable.email'] = 'true';
$conf['settings']['default.language'] = 'en_gb';
$conf['settings']['script.url'] = 'http://amfbooking.uk:8888/Web';
...
$conf['settings']['database']['user'] = 'amfbooking';
$conf['settings']['database']['password'] = 'bookingamf';
$conf['settings']['database']['hostspec'] = 'localhost';
$conf['settings']['database']['name'] = 'amfbooking';
...
$conf['settings']['install.password'] = '58edef6753fca';
